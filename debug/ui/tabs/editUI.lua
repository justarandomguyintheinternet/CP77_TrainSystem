...
-- Meta info
    ...
    if state then
        ...
        ImGui.Text("FIRST:")
        track.connectedID.first.front = ImGui.InputInt('front', track.connectedID.first.front)
        track.connectedID.first.back = ImGui.InputInt('back', track.connectedID.first.back)
        ImGui.Separator()
        ImGui.Text("SECOND:")
        ImGui.PopID()
        ImGui.PushID("connectedIDSECOND")
        track.connectedID.second.front = ImGui.InputInt('front', track.connectedID.second.front)
        track.connectedID.second.back = ImGui.InputInt('back', track.connectedID.second.back)
        ImGui.Separator()
        ImGui.PopID()
        ImGui.Text("Has Station: ")
        track.station.front = ImGui.InputInt('front', track.station.front)
        track.station.back = ImGui.InputInt('back', track.station.back)
    end
...
-- Rotation
    ...
    if state then
        ...
        point.loadStation.front = ImGui.Checkbox('front', point.loadStation.front)
        point.loadStation.back = ImGui.Checkbox('back', point.loadStation.back)
        ImGui.Text("front: Triggers if track is being used backwards (index decrease), and vice versa")
        ImGui.PopID()

        ImGui.Separator()

        ImGui.Text("Unload Station / Despawn Train")
        point.unloadStation.front = ImGui.Checkbox('front', point.unloadStation.front)
        point.unloadStation.back = ImGui.Checkbox('back', point.unloadStation.back)
    end
